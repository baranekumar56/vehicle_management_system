...
DROP TRIGGER IF EXISTS vehicle_service_price_time_change ON vehicle_service;
DROP TRIGGER IF EXISTS package_time_price_add_trigger ON package_service;
DROP TRIGGER IF EXISTS package_time_price_remove_trigger ON package_service;
